...
class UNet3D(nn.Module):
    ...
    def forward(self, input):
        ...
        out,_ = self.s_block1(out, residual_level1)
...
if __name__ == '__main__':
    ...
    model = UNet3D(in_channels=2, num_classes=2).cuda()
    start_time = time.time()
    summary(model=model, input_size=(2, 64, 64, 64), batch_size=8, device="cuda")
